...
class LightThemeTeal extends AppTheme {
  @override
  AppColors get colors => LightColorsTeal();
...
class LightColorsTeal extends AppColors {
  ...
  @override
  Color get primary => const Color(0xff008080); // Teal primary color

  @override
  Color get primary2nd => const Color(0xff006666); // Darker teal

  @override
  Color get primary3rd => const Color(0xff339999); // Lighter teal

  @override
  Color get primary4th => const Color(0xff66b2b2); // Even lighter teal

  @override
  Color get primary5th => const Color(0xff99cccc); // Very light teal

  @override
  Color get primary6th => const Color(0xffcce5e5); // Palest teal
