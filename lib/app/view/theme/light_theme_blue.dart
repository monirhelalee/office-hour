...
class LightColorsBlue extends AppColors {
  ...
  @override
  Color get primary => const Color(0xff007bff); // Blue primary color

  @override
  Color get primary2nd => const Color(0xff0056b3); // Darker blue

  @override
  Color get primary3rd => const Color(0xff3399ff); // Lighter blue

  @override
  Color get primary4th => const Color(0xff66b3ff); // Even lighter blue

  @override
  Color get primary5th => const Color(0xff99ccff); // Very light blue

  @override
  Color get primary6th => const Color(0xffcce6ff); // Palest blue
